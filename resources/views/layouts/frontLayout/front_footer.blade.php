        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        <h2>About Shopper</h2>
                        <form class="form-horizontal" method="post" action="{{ url('/add-subscriber-email') }}" > {{ csrf_field() }}
                            <input  name="subscriber_email" id="subscriber_email" type="email" placeholder="Your email address" required="" />
                            <button onclick="addSubscriber();" id="btnSubmit" type="submit" class="btn btn-default"><i class="fa fa-arrow-circle-o-right"></i></button>
